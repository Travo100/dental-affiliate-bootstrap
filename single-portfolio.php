...
/*
  ...
  Desciption: Page for displaying single pages of the portfolio
*/
  ...
  <div class="page-header">
    ...
    <div class="row">
      ...
      <div class="col-xs-3 prev-next">
        ...
        <a href="<?php bloginfo('url'); ?>/?p=70"><span class="glyphicon glyphicon-th"></span></a>
...
<div class="row">
      ...
      <?php if (have_posts() ): while ( have_posts() ) : the_post(); ?> <!-- wordpress loop to display content -->
        ...
        <div class="col-sm-4">
          ...
          <p><a class="btn btn-large btn-primary" href="<?php the_field('link'); ?>">View Final Piece <span class="glyphicon glyphicon-arrow-right"></span></a>
